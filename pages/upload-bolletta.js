...
export default function UploadBolletta() {
  ...
  return (
    <main className="p-6">
      <h1 className="text-xl font-semibold mb-4">Upload Bolletta (Pubblica)</h1>
      <input type="file" accept="application/pdf" onChange={e => setFile(e.target.files[0])} />
      <button onClick={handleUpload} className="mt-2 px-4 py-2 bg-blue-600 text-white rounded">Invia</button>
